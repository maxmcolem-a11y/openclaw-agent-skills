...
Public copies of agent skills used by Max's OpenClaw workspace for onboarding and reference.

Canonical local skill files may live in an OpenClaw workspace, but Trello onboarding cards should link here or to the upstream OpenClaw skill repo so agents outside the original filesystem can read the instructions.

## Skills

- [cad](skills/cad/SKILL.md)
- [multi-search-engine](skills/multi-search-engine/SKILL.md)
- [render](skills/render/SKILL.md)
